...
<ol class="breadcrumb"  style="margin-bottom: 10px;">
    ...
    <li><a href="Open_purchases">Open Purchases</a></li>
</ol>
...
<div id="div_delivery_list">
    <div class="panel panel-default">
        <div class="panel-body table-responsive" style="overflow-x: hidden;">
            <h2 style="margin-bottom: 0;" class="h2-panel-heading"> Open Purchases Report</h2><hr>
            <div class="row">
                ...
                <div class="col-lg-3">&nbsp; <br>
                <button class="btn btn-success pull-left" id="btn_export" title="Export" >
...
$(document).ready(function(){
    ...
    var initializeControls=function(){
        ...
        dt=$('#tbl_delivery_invoice').DataTable({
            ...
            "ajax" : "Open_purchases/transaction/list",
            "columns": [
                {
    ...
    var bindEventHandlers=(function(){
        ...
        $('#btn_print').click(function(){
            window.open('Open_purchases/transaction/report');
        });

        $('#btn_export').on('click', function() {
            window.open('Open_purchases/transaction/export','_self');
        });
