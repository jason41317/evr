...
<br />
    <div class="tab-container tab-warning">
        <ul class="nav nav-tabs">
            ...
            <li><a data-toggle="tab" href="#pcj" id="btn_products">Petty Cash Journal</a></li>
...
<!--                 <button class="btn btn-success pull-left" style="margin-right: 5px; margin-top: 10px; margin-bottom: 10px;" id="btn_email_sje_summary" style="text-transform: none; font-family: Tahoma, Georgia, Serif; " data-toggle="modal" data-target="#" data-placement="left" title="Email" ><i class="fa fa-share"></i> Email (SUMMARY)</button>       -->             
            ...
            <div id="pcj" class="tab-pane fade in">
                <button class="btn btn-primary pull-left" style="margin-right: 5px; margin-top: 10px; margin-bottom: 10px;" id="btn_print_pcj" style="text-transform: none; font-family: Tahoma, Georgia, Serif; " data-toggle="modal" data-target="#salesInvoice" data-placement="left" title="Print" ><i class="fa fa-print"></i> Print Report</button>
                <button class="btn btn-primary pull-left" style="margin-right: 5px; margin-top: 10px; margin-bottom: 10px;" id="btn_print_pcj_summary" style="text-transform: none; font-family: Tahoma, Georgia, Serif; " data-toggle="modal" data-target="#" data-placement="left" title="Print" ><i class="fa fa-print"></i> Print Summary</button>
                <button class="btn btn-success pull-left" style="margin-right: 5px; margin-top: 10px; margin-bottom: 10px;" id="btn_excel_pcj" style="text-transform: none; font-family: Tahoma, Georgia, Serif; " data-toggle="modal" data-target="#" data-placement="left" title="Excel" ><i class="fa fa-file-excel-o"></i> Export (DETAILED)</button>                                                    
<!--                 <button class="btn btn-success pull-left" style="margin-right: 5px; margin-top: 10px; margin-bottom: 10px;" id="btn_email_pcj" style="text-transform: none; font-family: Tahoma, Georgia, Serif; " data-toggle="modal" data-target="#" data-placement="left" title="Email" ><i class="fa fa-share"></i> Email (DETAILED)</button>   -->                                                      
                <button class="btn btn-success pull-left" style="margin-right: 5px; margin-top: 10px; margin-bottom: 10px;" id="btn_excel_pcj_summary" style="text-transform: none; font-family: Tahoma, Georgia, Serif; " data-toggle="modal" data-target="#" data-placement="left" title="Excel" ><i class="fa fa-file-excel-o"></i> Export (SUMMARY)</button>                    
<!--                 <button class="btn btn-success pull-left" style="margin-right: 5px; margin-top: 10px; margin-bottom: 10px;" id="btn_email_pcj_summary" style="text-transform: none; font-family: Tahoma, Georgia, Serif; " data-toggle="modal" data-target="#" data-placement="left" title="Email" ><i class="fa fa-share"></i> Email (SUMMARY)</button>                -->   
                <table id="tbl_pcj" style="margin-top: 10px;" class="table table-striped" cellspacing="0" width="100%">
                    <thead class="">
                    <tr>
                        <th></th>
                        <th width="10%">Date</th>
...
$(document).ready(function(){
   var dtGJE; var dtCDJ;
    ...
    var bindEventControls=function(){
        ...
        $('#btn_print_pcj').click(function(){
            window.open('TAccount/transaction/journal-report?b=PCJ&s='+$('#txt_start').val()+'&e='+$('#txt_end').val()+'&d='+_cboDepartmentID.val());
        });
...
// SUMMARY PRINT
        ...
        $('#btn_print_pcj_summary').click(function(){
            window.open('TAccount/transaction/journal_report_summary?b=PCJ&s='+$('#txt_start').val()+'&e='+$('#txt_end').val()+'&d='+_cboDepartmentID.val());
        });
...
// EXPORT TO EXCEL
        ...
        $('#btn_excel_pcj').click(function(){
                window.open('TAccount/transaction/journal-report-export?b=PCJ&s='+$('#txt_start').val()+'&e='+$('#txt_end').val()+'&d='+_cboDepartmentID.val());
        });
...
//EMAIL ATTACHMENT
        ...
        $('#btn_email_pcj').on('click', function() {
        showNotification({title:"Sending!",stat:"info",msg:"Please wait for a few seconds."});
        ...
        $.ajax({
            "dataType":"json",
            "type":"POST",
            "url":"TAccount/transaction/journal-report-email?b=PCJ&s="+$('#txt_start').val()+'&e='+$('#txt_end').val(),
            "beforeSend": showSpinningProgress(btn)
        }).done(function(response){
            showNotification(response);
            showSpinningProgress(btn);
...
//SUMMARY EXCEL
        ...
        $('#btn_excel_pcj_summary').click(function(){
            window.open('TAccount/transaction/journal_report_export_summary?b=PCJ&s='+$('#txt_start').val()+'&e='+$('#txt_end').val()+'&d='+_cboDepartmentID.val());
        });
...
//EMAIL SUMMARY
        ...
        $('#btn_email_pcj_summary').on('click', function() {
        showNotification({title:"Sending!",stat:"info",msg:"Please wait for a few seconds."});
        ...
        $.ajax({
            "dataType":"json",
            "type":"POST",
            "url":"TAccount/transaction/journal-report-email-summary?b=PCJ&s="+$('#txt_start').val()+'&e='+$('#txt_end').val()+'&d='+_cboDepartmentID.val(),
            "beforeSend": showSpinningProgress(btn)
        }).done(function(response){
            showNotification(response);
            showSpinningProgress(btn);
    ...
    function reloadGJE() {
        ...
        dtPCJ=$('#tbl_pcj').DataTable({
            ...
            "footerCallback": function(a,b,c){
                ...
                $('#tbl_pcj #td_dr_total').html('<b>'+accounting.formatNumber(total_dr,2)+'</b>');
                $('#tbl_pcj #td_cr_total').html('<b>'+accounting.formatNumber(total_cr,2)+'</b>');
            }
