    ...
    $(document).ready(function(){
        ...
        var initializeControls=function(){
            ...
            var createToolBarButton=function() {
                ...
                var _refresh='<button class="btn btn-default" id="btn_refresh_check_list" style="text-transform: none;font-family: Tahoma, Georgia, Serif;" data-toggle="modal" data-target="" data-placement="left" title="Refresh" >'+
