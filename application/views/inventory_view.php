                                                ...
                                                <div id="collapseTwo" class="collapse in">
                                                    ...
                                                    <h2 class="h2-panel-heading">Inventory Report</h2><hr>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-2">
                                                                    Product Type * : <br />
                                                                    <select id="cbo_product_types" class="form-control">
...
<script>
    $(document).ready(function(){
        var dt; var _cboDepartment; var _cboSuppliers; var _cboProductType;
        ...
        var initializeControls=function(){
            ...
            _cboDepartment.select2("val", default_department_id);
            ...
            _cboProductType=$("#cbo_product_types").select2({
                placeholder: "Choose Type",
                allowClear: false
            });

            _cboProductType.select2("val", 3);
        ...
        var bindEventControls=function(){
            ...
            $('#cbo_product_types').on('change',function(){
                dt.clear().draw();
                dt.destroy();
                reloadList();
            });
            ...
            $(document).on('click','#btn_print_detailed',function(){
                window.open('Inventory_report/transaction/preview-inventory-with-total?depid='+$('#cbo_department').val()+'&date='+$('#txt_date').val()+'&ccf='+$('#cbo_current_count').val());
            });
            
            $(document).on('click','#btn_export_detailed',function(){
                window.open('Inventory_report/transaction/export-inventory-with-total?depid='+$('#cbo_department').val()+'&date='+$('#txt_date').val()+'&ccf='+$('#cbo_current_count').val());
            });

            $(document).on('click','#btn_export',function(){
                window.open('Inventory_report/transaction/export-inventory?depid='+$('#cbo_department').val()+'&date='+$('#txt_date').val()+'&ccf='+$('#cbo_current_count').val()+'&supid='+$('#cbo_suppliers').val()+'&prod_type_id='+$('#cbo_product_types').val());
            });
            ...
            $(document).on('click','#btn_email',function(){
                ...
                $.ajax({
                    "dataType":"json",
                    "type":"POST",
                    "url":'Inventory_report/transaction/email-inventory?depid='+$('#cbo_department').val()+'&date='+$('#txt_date').val()+'&ccf='+$('#cbo_current_count').val(),
            ...
            $('#tbl_inventory tbody').on( 'click', 'tr td.details-control', function () {
                ...
                if ( row.child.isShown() ) {
                    ...
                    $.ajax({
                        "dataType":"html",
                        "type":"POST",
                        "url":"Products/transaction/product-history?id="+ d.product_id+"&depid="+$('#cbo_department').val()+"&date="+$('#txt_date').val()+'&type=1',
                        "beforeSend" : function(){
            ...
            dt=$('#tbl_inventory').DataTable({
                ...
                "ajax": {
                    ...
                    "data": function ( d ) {
                        return $.extend( {}, d, {
                            ...
                            "supid" : $('#cbo_suppliers').val(),
                            "prod_type_id" : $('#cbo_product_types').val(),
                            "date" : $('#txt_date').val(),
                ...
                "columns": [
                    ...
                    },
                    {
                        ...
                        data: null,
                        render: function(data, type, full, meta){
                            return accounting.formatNumber(data.on_hand,2);
                        }
