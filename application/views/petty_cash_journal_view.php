...
<!--                                                     <div class="panel-heading">
                        ...
                        <div class="modal-content"><!---content-->
                            ...
                            <div class="row col-sm-12" style="padding-top: 10px;">
                                    <div class="col-xs-12 col-md-12" style="margin-bottom: 10px;">
                                        ...
                                        <select id="cbo_supplier_id" name="supplier_id" class="form-control" style="width: 100%;" data-error-msg="Supplier is required" required>
    ...
    (function() {
        ...
        var initializeControls=function() {
            ...
            _cboSupplierReplenish = $('#cbo_supplier_id').select2({
                placeholder: "Please select Supplier"
            });   

            _cboSupplierReplenish.select2('val', null);  
