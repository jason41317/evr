...
<script>
    $(document).ready(function(){
        var dt; var _cboDepartment; var _cboSupplier; var _cboProductType;
        ...
        var initializeControls=function(){
            ...
            _cboSupplier=$("#cbo_suppliers").select2({
                placeholder: "Choose Supplier",
                allowClear: false
            });

            _cboSupplier.select2("val", 0);
        ...
        var bindEventControls=function(){
            ...
            $(document).on('click','#btn_export',function(){
                window.open('Batch_inventory/transaction/export-batch-inventory?type=export&supid='+$('#cbo_suppliers').val()+'&prod_type_id='+$('#cbo_product_types').val()+'&depid='+$('#cbo_department').val()+'&date='+$('#txt_date').val()+'&ccf='+$('#cbo_current_count').val());
            });
        ...
        function reloadList(){
            ...
            dt=$('#tbl_inventory').DataTable({
                ...
                "columns": [
                    ...
                    { targets:[2],data: "exp_date" },
                    { targets:[3],data: "batch_no" },
                    {
