        ...
        <table width="100%" cellspacing="0">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <!-- 270px -->
                    <span style="position: absolute; margin-top: 555px; margin-left: 600px;font-family: 'Times New Roman', serif; font-weight: 200;"><?php echo number_format($sales_info->total_before_tax,2); ?></span>
                </tr>
                <tr>
                    ...
                    <!-- 300px -->
                    <span style="position: absolute; margin-top: 585px; margin-left: 600px;font-family: 'Times New Roman', serif; font-weight: 200;"><?php echo number_format($sales_info->total_tax_amount,2); ?></span>
                </tr>
                <tr>
                    ...
                    <!-- 330px -->
                    <span style="position: absolute; margin-top: 615px; margin-left: 600px;font-family: 'Times New Roman', serif; font-weight: 200;"><strong><?php echo number_format($sales_info->total_after_tax,2); ?></strong></span>
                </tr>
            </tbody>
        </table>
    </div>
