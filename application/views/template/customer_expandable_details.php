                        ...
                        <div class="tab-pane active" id="customer_info" style="min-height: 300px;">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-5"><br />
                                    ...
                                    <!--<i class="fa fa-star-o"></i> Total Unpaid : <b><?php  number_format($customer_info->total_receivable_amount,2); ?></b><br /><br /><br /><br /><br /> -->
									<i class="fa fa-star-o"></i> Total Unpaid : <b><?php echo number_format($updated_receivable,2); ?></b><br /><br /><br /><br /><br />
                                </div>
                            </div>
