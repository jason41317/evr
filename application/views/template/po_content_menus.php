    ...
    <div class="col-lg-12">
        <div class="title-action" style="margin-left: 3%;">
           <!--  <a id="btn_email" data-supplier-email="<?php echo $purchase_info->email_address; ?>" class="btn btn-primary <?php echo ($purchase_info->approval_id==2?'disabled':''); ?>" style="text-transform:none;font-family: tahoma;" ><i class="fa fa-envelope"></i> <span class=""></span> Email to Supplier</a> -->
            ...
            <a href="Templates/layout/po/<?php echo $purchase_info->purchase_order_id; ?>?type=pdf" class="btn btn-default <?php echo (in_array('20-6',$this->session->user_rights)?'':'hidden'); ?> <?php echo ($purchase_info->approval_id==2?'disabled':''); ?>" style="text-transform:none;font-family: tahoma;" ><i class="fa fa-file-pdf-o"></i> Download as PDF </a>
        </div>
    </div>
