                ...
                <div class="tab-container tab-top tab-default">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="supplier_info" style="min-height: 300px;">
                            ...
                            <div class="row">
                                <div class="col-lg-7">
                                    <h4><span style="margin-left: 1%"><strong><i class="fa fa-user"></i> <?php echo $supplier_info->supplier_name; ?></strong></span></h4>
                                    <hr />
                                ...
                                <div class="col-lg-5"><br />
                                   ...
                                   <!-- <i class="fa fa-star-o"></i> Total Unpaid : <b><?php number_format($supplier_info->total_payable_amount,2); ?></b><br /><br /><br /><br /><br /> -->
									 <i class="fa fa-star-o"></i> Total Unpaid : <b><?php echo number_format($updated_payable,2); ?></b><br /><br /><br /><br /><br />
                                </div>
                            </div>
