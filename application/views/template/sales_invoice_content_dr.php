        ...
        <table width="100%" cellpadding="10" cellspacing="0" class="table-border" border="1">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td width="30%" class="table-cellpadding tbl-border-si tbl-center"  style="font-size: 15px;font-family: 'Times New Roman', serif; font-weight: 200;"><center><?php echo number_format($item->inv_qty * $item->inv_price,2); ?></center></td>
                </tr>
                <?php
                } 
