...
<script>
    ...
    $(document).ready(function(){
        ...
        function createToolBar(){
            var _print='<button id="btn_print" class="btn btn-default" style="text-transform: none;"><i class="fa fa-print"></i> Print Report</button>';
            var  _refresh='<button id="btn_refresh" class="btn btn-default" style="text-transform: none;margin-left: 5px;"><i class="fa fa-refresh"></i> Refresh</button>';
