<?php
    ...
    class Products_model extends CORE_Model {
        ...
        function get_order_list($product_type_id=3,$description,$department_id=null,$supplier_id=null,$is_active=null){
            $sql="SELECT
                    p.product_id,
                    p.product_code,
                    p.product_desc,
                    ...
                    WHERE p.is_deleted=FALSE AND p.is_active=TRUE AND
        ...
        function get_inventory($as_of_date,$product_type_id=3,$is_show_all=TRUE,$supplier_id=0,$department_id=0,$status=-1){
            $sql="SELECT
